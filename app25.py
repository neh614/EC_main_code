...
def image():
    if request.method == 'POST':
        ...
        laplacian = laplace(median_filtered)
        laplacian_image = median_filtered - laplacian * 255
       ...
       # Apply Gaussian Blur and thresholding
        ...
        for contour in contours:
            ...
            if solidity > 0.94 and circularity > 0.84:
                grade = "Low Grade (Well-Organized)"
            elif 0.65 < solidity <= 0.76 and 0.64 < circularity <= 0.85:
...
##        def predict_and_display_image(model, img_path, class_labels):
        ...
        'Median Filter', 'Laplacian',  'Adaptive Threshold',
