...
def image():
    if request.method == 'POST':
        ...
        high_pass = cv2.Laplacian(gaussian_filtered, cv2.CV_64F)
        ...
        adaptive_threshold = cv2.adaptiveThreshold(gaussian_threshold, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, 
